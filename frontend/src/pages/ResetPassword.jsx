...
const ResetPassword = () => {
  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-gradient-to-br from-blue-200 to-purple-400">
      ...
      {!isEmailSent && (
        <form onSubmit={onSubmitEmail} className="bg-slate-900 p-8 rounded-lg shadow-lg w-100 text-sm">
          ...
          <div className="mb-4 flex items-center gap-3 w-full px-5 py-2.5 rounded-full bg-[#333A5C]">
            ...
            <input
              ...
              value={email}
              className="background-transparent outline-none text-white"
              type="email"
      ...
      {isEmailSent && isOtpSubmitted && (
        <form onSubmit={onSubmitNewPassword} className="bg-slate-900 p-8 rounded-lg shadow-lg w-100 text-sm">
          <h1 className="text-white text-2xl font-semibold text-center mb-4">
            Enter New Password
          </h1>
          <p className="text-center mb-6 text-indigo-300">
